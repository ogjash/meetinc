    ...
    return(
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" side="right" className="w-72">
                ...
                <DropdownMenuItem className="cursor-pointer flex flex-center justify-between">
                    Billing
                    <CreditCardIcon className="size-4 "/>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={onLogout} className="cursor-pointer flex flex-center justify-between">
                    LogOut
